                               ...
                               <form name="form1" action="" method="post">
							     <table>
								    <tr> 
									 ...
									 <td> <input type="submit" value="search" name="submit1" class="form-control btn btn-success" style="margin-top: 5px"></td>
									 <td>
									</tr>
									</table>
									<?php 
									      ...
									      while($row5=mysqli_fetch_array($res5))
									{
								      ...
								      <tr> 
								       ...
								       <td> 
										...
										<tr> 
								       <td> 
									    <input type="submit" value="issue books"  name="submit2" class="form-control btn btn-success" >
								         </td>
								        </tr>
