                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a href="dispaly_student_info.php"><i class="fa fa-home"></i> All Student Info <span class="fa fa-chevron-down"></span></a>

                            </li>
                           
                            <li><a href="add_books.php"><i class="fa fa-edit"></i> Add Books <span
                            ...
                            <li><a href="books_details_with_student.php"><i class="fa fa-bar-chart-o"></i> Books With All Info <span class="fa fa-chevron-down"></span></a>
