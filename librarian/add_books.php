...
?>
                                ...
                                <table class="table table-bordered"> 
								 <tr> 
								  ...
								  <td> 
								   ...
								   <tr>
								  <td> 
									     <input type="text"  class="form-control" placeholder="book year id" name="byid" required=""/>
								     </td>
								  </tr>
								   <tr>
                                      <td> 
									     <input type="submit" name="submit1" class="btn btn-success" value="insert book details">
								     </td>
								  </tr>
		...
		<?php 
		   ...
		   {     $tm=md5(time()) ;
			   ...
			   mysqli_query($link,"insert into add_books values('','$_POST[booksname]','$dst1','$_POST[bauthorname]','$_POST[pname]','$_POST[bpurchasedt]','$_POST[bprice]','$_POST[bqty]','$_POST[aqty]','$_SESSION[librarian]','$_POST[byid]')") ;
